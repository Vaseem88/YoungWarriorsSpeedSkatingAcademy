...
<div>Special needs children of any age</div>
        ...
        <div>
           <h2 class="font-semibold text-2xl mt-8">✨ Our Goal</h2>
           <div class="mt-4">To create a fun, safe, and inclusive sports academy where every child and adult can learn, grow, and become a confident athlete.</div>
        </div>
    </div>
</template>
